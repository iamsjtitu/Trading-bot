                    ...
                    <>
                        ...
                        <Button onClick={async () => {
                          ...
                          try {
                            ...
                            if (e.response?.status === 404) {
                              alert('Telegram API not available. Desktop app rebuild required for v8.0.0 features.');
                      ...
                      <Button onClick={async () => {
                        try {
                          ...
                          if (e.response?.status === 404) { alert('Desktop app rebuild required for v8.0.0.'); }
                          else { alert('Error: ' + (e.response?.data?.message || e.message)); }
                        }
