                    ...
                    <>
                        ...
                        <Button onClick={async () => {
                          ...
                          try {
                            ...
                            if (e.response?.status === 404) {
                              alert('Telegram API not available. Desktop app rebuild required for latest features.');
                      ...
                      <Button onClick={async () => {
                        try {
                          ...
                          if (e.response?.status === 404) { alert('Desktop app rebuild required for latest features.'); }
                          else { alert('Error: ' + (e.response?.data?.message || e.message)); }
                        }
